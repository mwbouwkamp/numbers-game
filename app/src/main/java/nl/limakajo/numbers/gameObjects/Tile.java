 ...
 * @author M.W.Bouwkamp
 */
public class Tile extends GameObject implements AnimatesPosition {
	...
	@Override
	public void update() {
		if (positionAnimator.isAnimating() || position != positionAnimator.getCurrentState()) {
			position = positionAnimator.getCurrentState();
		}
	}
